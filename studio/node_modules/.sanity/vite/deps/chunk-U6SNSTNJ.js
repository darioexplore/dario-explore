...
import {
  ...
  useToast,
  yt
} from "./chunk-JJGP63JK.js";
import {
  require_dist
} from "./chunk-LMUOYIKA.js";
import {
  require_jsx_runtime,
  require_react
} from "./chunk-KFPPGFRP.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-OAIAO4EY.js")
});
...
var ChevronWrapper = yt(Box)`
  margin-left: auto;
`;
var CrossDatasetReferencesDetails = yt.details`
  flex: none;
...
`;
var CrossDatasetReferencesSummary = yt.summary`
  list-style: none;
...
var DialogBody$1 = yt(Box)`
  box-sizing: border-box;
`;
var LoadingContainer = yt(Flex).attrs({
  align: "center",
  direction: "column",
  justify: "center"
})`
...
var TitleTextSkeleton = yt(TextSkeleton)`
  width: 66%;
  max-width: 175px;
`;
var TitleText = yt(Text)`
  cursor: default;
  outline: none;
`;
...
var VersionModeHeaderLayout = yt.header`
  display: grid;
  grid-area: header;
  grid-template-columns: 1fr min-content 1fr;
  border-block-end: 1px solid var(--card-border-color);
`;
var VersionModeHeaderLayoutSection = yt.div`
  display: flex;
...
`;
var DiffViewPaneLayout = yt(Card)`
  position: relative;
  grid-area: var(--grid-area);
`;
var Container2 = yt(Container)`
  width: auto;
`;
...
var JSONInspectorWrapper = yt.div(({
  theme
}) => {
  const {
    color,
...
var DocumentBox = yt(Box)({
  position: "relative"
});
var Scroller$4 = yt(ScrollContainer)(({
  $disabled
}) => $disabled ? {
  height: "100%"
} : pt`
...
var HorizontalScroller = yt(Card)((props) => {
...
var FlipIcon = yt(ChevronLeftIcon)`
...
var StackWrapper = yt(Stack)`
  max-width: 200px;
`;
var ListWrapper = yt(Flex)`
...
var NameSkeleton = yt(Skeleton)((props) => {
  const theme = getTheme_v2(props.theme);
  return pt`
    width: 6ch;
...
var StyledMotionPath = yt(motion.path)`
...
var StyledChangeConnectorRoot = yt(ChangeConnectorRoot)`
  flex: 1;
  display: flex;
...
`;
var AnimatedSpinnerIcon = yt(SpinnerIcon)`
  animation: ${rotate} 500ms linear infinite;
`;
var SubtleSpinnerIcon = yt(SpinnerIcon)`
  animation: ${rotate} 1500ms linear infinite;
  opacity: 0.4;
`;
var DelayedSubtleSpinnerIcon = yt(SpinnerIcon)`
  animation:
...
`;
var PinnedDataCell = yt(DataCell)`
  position: sticky;
  z-index: 2;
`;
...
`;
var PinnedHeader = yt(Header)`
  position: sticky;
  z-index: 2;
`;
var HoverMenu = yt.div`
  visibility: hidden;
...
var PaneContainer$1 = yt(Flex)`
  height: 100%;
`;
var TableContainer = yt.div`
...
var Scroller$3 = yt(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$2 = yt(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$1 = yt(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller = yt(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-PHDVV46M.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-U6SNSTNJ.js.map
