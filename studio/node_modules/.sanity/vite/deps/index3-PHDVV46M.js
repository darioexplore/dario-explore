import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-U6SNSTNJ.js";
import "./chunk-RL6PXUMB.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
import "./chunk-LYOHUSQB.js";
import "./chunk-U7QCN5DP.js";
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-SHDURLRZ.js")),
  document: (0, import_react.lazy)(() => import("./pane-DLK4RHPZ.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-DLK4RHPZ.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-6UKVNYVL.js"))
};
...
var StyledPaneLayout = yt(PaneLayout)`
  min-height: 100%;
  min-width: 320px;
`;
...
//# sourceMappingURL=index3-PHDVV46M.js.map
